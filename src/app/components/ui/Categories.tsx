...
const categories = [
  {
    ...
    deals: [
      ...
      { logo: "/assets/viator-logo.svg", offer: "15% Off Priceline Coupon" },
      { logo: "/assets/viator-logo.svg", offer: "Upto 50% Off Viator Coupons" },
      { logo: "/assets/viator-logo.svg", offer: "15% Off Priceline Coupon" },
      { logo: "/assets/viator-logo.svg", offer: "Upto 50% Off Viator Coupons" },
      { logo: "/assets/viator-logo.svg", offer: "15% Off Priceline Coupon" },
        ...
        <div className="w-64 relative">
          ...
          <div className="space-y-6">
            {categories.map((category, index) => (
              ...
              >
                <div className="w-9 h-9 rounded-full bg-white border-2 border-[#14303B] z-10 flex items-center justify-center">
                  {category.icon}
                </div>
          ...
          {selectedCategory.deals.length > 0 ? (
            selectedCategory.deals.map((deal, index) => (
              <div key={index} className="flex items-start">
                ...
                <div className="flex items-center justify-center w-[160px] h-[60px] bg-gray-50 rounded-l-lg shadow-sm relative z-10">
                  <img
                ...
                <div className="flex-1 flex items-center border border-l-0 border-[#96C121] rounded-r-lg -ml-2 pl-4 pr-3 py-3 mt-2">
