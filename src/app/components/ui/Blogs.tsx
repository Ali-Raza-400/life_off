...
function Blogs() {
  return (
    <div className="max-w-[1440px]  min-h-screen bg-white p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-[35px] font-bold mb-8">Blogs</h1>
          ...
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="w-2/3 p-6">
                <h2 className="text-[18.18px] font-semibold mb-2 line-clamp-2">
                  {post.title}
                </h2>
                
                <div className="flex items-center gap-2 text-[12.73px] text-gray-600 mb-3">
                  <span>{post.author}</span>
                  <span>•</span>
                  <span>{post.date}</span>
                </div>
                
                <p className="text-gray-600 line-clamp-2 text-[15.66px]">
                  {post.description}
                </p>
              </div>
            </div>
